...
test("astroRehypeRelativeMarkdownLinks", async (t) => {
  ...
  await t.test("should keep query and fragment for file paths that exist", async () => {
  ...
  await t.test("should prefix base to output on file paths that exist", async () => {
    const input = '<a href="./fixtures/test.md">foo</a>';
    const { value: actual } = await rehype()
      .use(testSetupRehype)
  ...
  await t.test("should contain trailing slash when option not specified and file contains", async () => {
    const input = '<a href="./fixtures/test.md/">foo</a>';
    const { value: actual } = await rehype()
      .use(testSetupRehype)
      .use(astroRehypeRelativeMarkdownLinks, { contentPath: "src" })
  ...
  await t.test("should not contain trailing slash when option not specified and file does not contain", async () => {
    const input = '<a href="./fixtures/test.md">foo</a>';
    const { value: actual } = await rehype()
      .use(testSetupRehype)
      .use(astroRehypeRelativeMarkdownLinks, { contentPath: "src" })
  ...
  await t.test("should contain trailing slash when option not specified and file does not contain and custom slug contains", async () => {
    const input =
  ...
  await t.test("should not contain trailing slash when option not specified and file contains and custom slug does not contain", async () => {
    const input =
  ...
  await t.test("should not contain trailing slash when option not specified and file contains and custom slug contains", async () => {
    const input =
      '<a href="./fixtures/dir-test-custom-slug/with-trailing-slash.md/">foo</a>';
    const { value: actual } = await rehype()
      .use(testSetupRehype)
